...
<div class="edit-container">
    ...
    <form method="POST" action="update_task.php">
        <div class="form-group">
            ...
            <input type="text" id="taskName" class="form-control" placeholder="Enter task name" value="<?= isset($todo['title']) ? htmlspecialchars($todo['title']) : '' ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" id="taskDueDate" class="form-control" value="<?= isset($todo['due_date']) ? htmlspecialchars($todo['due_date']) : '' ?>">
        </div>
